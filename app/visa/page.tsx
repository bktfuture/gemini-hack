		...
		<div className={styles.main}>
			<div className={styles.col}>
				...
				<div className={styles.pbox}>
					<p>
						International students looking to study in the U.S. will need to obtain a student visa. Additionally, in order to obtain your Visa,
						applicants are required to pass an interview. The visa process is a lengthy one, and students are encouraged to prepare well in advance
						of the new academic year.
					</p>
					<p>
						In order to begin the student Visa application process, you must be accepted into a U.S. institution and receive a Certificate of
						Eligibility (Form I-20) from that institution. In addition to acceptance into a U.S. program, you must also provide evidence that you
						have sufficient funds at your disposal to pay for tuition, room, and boarding for the duration of your stay. This is essential and the
						Form I-20 cannot be issued without the appropriate financial documentation.
					</p>
					<p>
