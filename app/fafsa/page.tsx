	...
	return (
		<div className={styles.main}>
			<div className={styles.col}>
				...
				<h2 className={styles.h2}>Deadlines</h2>
				<div className={styles.pbox}>
					<ul>
				...
				<h2 className={styles.h2}>College Deadlines</h2>
				<div className={styles.pbox}>
					<p>
						...
						applying to multiple colleges, look up each school’s FAFSA® deadline and apply early.
					</p>
					<p>
						Many college FAFSA due dates also have priority deadlines, which means you need to submit your FAFSA form by that date to potentially
						receive the most money from the college. Many colleges have this date list on their financial aid webpages. If you can’t find it
						online, call the school’s Financial Aid Office.
					</p>
					<p>
						If you haven’t decided on which colleges you’re applying to yet, don’t worry! You can still submit your FAFSA form. Just list any
						school you’re considering, even if you may not apply. You can always add or remove schools from your FAFSA form later.
					</p>
				</div>
				<h2 className={styles.h2}>State Deadlines</h2>
				<div className={styles.pbox}>
					<p>
				...
				<h2 className={styles.h2}>Federal Deadline</h2>
				<div className={styles.pbox}>
					<p>
						...
						that you’re applying for becomes unavailable after June 30.
					</p>
					<p>
						For example, if you’re trying to apply for the 2024-25 school year, the FAFSA form will disappear from StudentAid.gov on June 30, 2025,
						because that’s the end of the 2024–25 academic year.
					</p>
					<p>That’s right—you can technically go through your entire year at college before submitting your FAFSA form.</p>
					<p>
						But earlier deadlines from colleges and states make waiting a bad idea.Apply as early as possible to increase your chances of receiving
						educational funding—and more of it!
					</p>
				</div>
			</div>
		</div>
