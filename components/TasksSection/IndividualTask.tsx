...
import DragIndicatorSVG from "../../public/icons/drag_indicator.svg";
...
function IndividualTask({ text }: IndividualTaskProps) {
    ...
    <div className="task">
      <div className="checkbox-and-task-text">
        <Image
          ...
          src={checkbox ? checkBoxMap[randomNumber] : BlankCheckBoxSVG}
          alt="checkbox"
        />
        <p
          className={
            checkbox ? "task-text-black-checkbox" : "task-text-blank-checkbox"
          }
        >
          {text}
        </p>
      </div>
      <div className="drag-indicator-outer-div">
        <Image src={DragIndicatorSVG} alt="Drag indicator" />
      </div>
    </div>
  );
}
