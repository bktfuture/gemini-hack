	...
	return (
		<nav className="navbar">
			<div className="left-nav">
				<Link href="/dashboard">
					<Image className="navbar-gemini-docs-logo" src={GeminiDocsLogoSVG} alt="Gemini Docs Logo" />
				</Link>
			</div>
			<div className="right-nav">
				...
				<Link href="universityapplications">
					<p className="navbar-university-applications-text">University Applications</p>
				</Link>
